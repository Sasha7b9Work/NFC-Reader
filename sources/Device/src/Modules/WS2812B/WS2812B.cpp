...
namespace WS2812B
{
    ...
    namespace DLED
    {
        ...
        // data представл€ет собой массив количества тактов, в которые нужно передЄргивать из 0 в 1 и обратно.
        // ¬ момент времени 0 нужно передЄрнуть в 1. ƒалее идут пары чисел, соответствующие переключению в 0 и в единицу
        // data[0] - окончание положительного импульса 0-го бита
        // data[1] - окончание отрицательного импульса 0-го бита
        // data[2], data[3] - бит 1
        // data[4], data[5] - бит 2
        // ¬ массиве не 96 * 2 элементов, а на 1 больше - заканчиваетс€ нулЄм.
