...
/** \file
* Generic MIFARE Classic contactless IC Application Component of Reader Library Framework.
* $Author$
* $Revision$ (v07.05.00)
* $Date$
*
...
phStatus_t phalMfc_GetVersion(
                              void * pDataParams,       /**< [In] Pointer to this layer's parameter structure. */
                              uint8_t * pVersion        /**< [Out] Version no  It should be of Length #PHAL_MFC_VERSION_LENGTH */
                              );
/** @} */
