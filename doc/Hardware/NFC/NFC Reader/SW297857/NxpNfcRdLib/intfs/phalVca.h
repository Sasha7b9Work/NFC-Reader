...
typedef enum
{
    ...
    VC_MFP_AUTH_AES_SL1                                             = 0x08, /**< State to indicate MIFARE Plus contactless IC PICC authenticated in Security Level 1. */
...
typedef struct
{
    ...
    void * pAlDataParams;                                                   /**< Pointer to the parameter structure of the MFDF EVx / MFP EVx component. */
 ...
 * ISO14443 Layer 3 activated state. This comand is supported by MIFARE Ultralight EV1 contactless IC and Mifare Plus product only.
 *
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 * \retval Other Depending on implementation and underlying component.
...
/**
 * \brief This new command is implementated to support VCA for MIFARE DESFire Ev2 and Mifare Plus EV1. Proximity Device answers with
