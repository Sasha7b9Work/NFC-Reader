...
#define PHPAL_MIFARE_ERR_NAK3   ((phStatus_t)PH_ERR_CUSTOM_BEGIN + 8U)     /**< NAK 3 */
/*@}*/
...
* MIFARE DESFire contactless IC and MIFARE Plus contactless IC.
* @{
*/
