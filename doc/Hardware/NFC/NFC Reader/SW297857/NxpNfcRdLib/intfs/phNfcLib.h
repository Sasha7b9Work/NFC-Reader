 ...
 * \brief Provides commands that can be performed on MIFARE Ultralight
 */
 ...
 * \brief Defines parameters that needs be provided by User to communicate with MIFARE Ultralight
 */
