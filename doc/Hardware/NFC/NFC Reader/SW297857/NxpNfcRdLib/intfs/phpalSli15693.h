 ...
 * */
#define PHPAL_SLI15693_TIMEOUT_DELTA_US        50000U

/**
 * Timeout T1 in microseconds, 160.5 is taken as 162us
 * Supported only by NTAG5 I2C
 * */
#define PHPAL_SLI15693_TIMEOUT_NTAG5_I2C_US    162U

/**
 * Timeout T1 in microseconds, 80.2 is taken as 81us
 * Supported only by NTAG5 I2C
 * */
 ...
 * */
#define PHPAL_SLI15693_TIMEOUT_EOF_US       17000U
 ...
 * Select_flag.
 *
 * If bit (b5) is set, only VICC in selected state shall respond. The Address_flag
 ...
 * Address_flag.
 *
 * If bit (b6) is set, request is addressed. UID field is included in request. It shall be
 ...
 * Address_flag.
 *
 * If bit (b6) is not set, request is not addressed. UID field is not included in request. It
