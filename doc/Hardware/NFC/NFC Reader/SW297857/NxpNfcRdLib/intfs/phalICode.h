...
#define PHAL_ICODE_CONFIG_ENABLE_BUFFERING                              0x04U    /**< Option to Get / Set the bufferring of response data to be enabled or disabled.By default this flag will be disabled. */
/* @} */
...
#define phalICode_AuthenticateMAM(pDataParams, bOption, bKeyNo, bKeyVer, bKeyNoCard, bPurposeMAM2, pDivInput, bDivLen) \
        phalICode_Sw_AuthenticateMAM((phalICode_Sw_DataParams_t *)pDataParams, bOption, bKeyNo, bKeyVer, bKeyNoCard, bPurposeMAM2, pDivInput, bDivLen)
