 ...
 *          Other Depending on implementation and underlaying component.
 */
phStatus_t phalICode_Int_I2CMRead (void * pPalSli15693DataParams, uint8_t bAddr_Config, uint8_t bDataLen, uint8_t * pData)
{
    phStatus_t  PH_MEMLOC_REM wStatus = 0;
    uint8_t     PH_MEMLOC_REM aCmdBuff[3];
    uint16_t    PH_MEMLOC_REM wRespLen = 0;
    ...
    aCmdBuff[1] = bAddr_Config;
    aCmdBuff[2] = (uint8_t) (bDataLen - 1U);
 ...
 *          Other Depending on implementation and underlaying component.
 */
phStatus_t phalICode_Int_I2CMWrite (void * pPalSli15693DataParams, uint8_t bAddr_Config, uint8_t * pData, uint8_t bDataLen)
{
    phStatus_t  PH_MEMLOC_REM wStatus = 0;
    uint8_t     PH_MEMLOC_REM aCmdBuff[3];
    uint8_t *   PH_MEMLOC_REM pResponse = NULL;
    ...
    /* Buffer data and exchange the bufferred information. */
    wStatus = phpalSli15693_Exchange(
        pPalSli15693DataParams,
        PH_EXCHANGE_BUFFER_LAST,
        pData,
