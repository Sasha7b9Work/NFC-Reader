...
/** \file
* Software MIFARE DESFire Light contactless IC Application Component of Reader Library Framework.
* $Author: NXP $
* $Revision: $ (v07.05.00)
* $Date: $
*/
    ...
    uint8_t bKeyNoCard, uint8_t * pDivInput, uint8_t bDivLen, uint8_t bLenPcdCapsIn, uint8_t *pPcdCapsIn, uint8_t *pPcdCapsOut, uint8_t *pPdCapsOut)
{
    ...
    {
        return PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_AL_MFDFLIGHT);
    }
    ...
    uint8_t bTmcLimitLen, uint8_t * pTmcLimit)
{
    ...
    {
        /* In this Case, here the bFileOption parameter is prepared as per MIFARE DESFire EV2 contactless IC Convention.
