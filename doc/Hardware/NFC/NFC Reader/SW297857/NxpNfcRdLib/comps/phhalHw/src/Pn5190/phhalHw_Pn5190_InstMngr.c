        ...
        phhalHw_InstMngr_CmdParams_t *pCmdParams, uint8_t bExchAction)
{
    ...
    if(bExchAction & QUEUE)
    {
        ...
        {
            phhalHw_Pn5190_Int_GetTxBuffer(pDataParams, &pTxBuffer, &wTxBufferLen, &wTxBufferSize);
...
static phStatus_t phhalHw_Pn5190_InstMngr_SendBuffdData(phhalHw_Pn5190_DataParams_t *pDataParams)
{
    ...
    phhalHw_Pn5190_Int_GetTxBuffer(pDataParams, &pTxBuffer, &wBuffrdDataLength, &wBufferSize);
        ...
        uint16_t wCurrSpaceNeeded)
{
    ...
    phhalHw_Pn5190_Int_GetTxBuffer(pDataParams, &ppTmpBuffer, &wPrevBuffrdDataLen, &wCurrBufferSize);
