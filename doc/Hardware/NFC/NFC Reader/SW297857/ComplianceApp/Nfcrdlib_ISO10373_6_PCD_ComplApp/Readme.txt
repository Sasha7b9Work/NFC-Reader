...
1 Document Purpose
2 Description of the NFCRDLIB_ISO10373_6_PCD_COMPLAPP
3 Restrictions on NFCRDLIB_ISO10373_6_PCD_COMPLAPP
4 Configurations of NFCRDLIB_ISO10373_6_PCD_COMPLAPP
5 Package Contents
6 Mandatory materials (not included)
7 Hardware Configuration
8 Software Configuration
9 Steps to build NFCRDLIB_ISO10373_6_PCD_COMPLAPP for LPC1769 with PN5190 using MCUXpresso
10 Steps to build NFCRDLIB_ISO10373_6_PCD_COMPLAPP for LPC1769 with PN5180 using MCUXpresso
11 Steps to build NFCRDLIB_ISO10373_6_PCD_COMPLAPP for LPC1769 with RC663 using MCUXpresso
12 Steps to build NFCRDLIB_ISO10373_6_PCD_COMPLAPP for PN7462AU using MCUXpresso
13 Steps to build NFCRDLIB_ISO10373_6_PCD_COMPLAPP for FRDM-K82F using MCUXpresso
14 Selection of Board / OSAL / Frontend (MCUXpresso)
15 Running NFCRDLIB_ISO10373_6_PCD_COMPLAPP
...
==================
  ...
  NFCRDLIB_ISO10373_6_PCD_COMPLAPP example as well as it's known problems and
  restrictions.
...
=====================================================
  ...
  - NFCRDLIB_ISO10373_6_PCD_COMPLAPP can be run with CLEV663B, PN5180, PN5190
    and PN7462AU.  (See Section-16 for supported versions)
...
==================================================
  ...
  - NFCRDLIB_ISO10373_6_PCD_COMPLAPP is restricted to be run on NFC Reader
...
==================
  ...
  - Readme.txt
    + This readme file
  - NFCRDLIB_ISO10373_6_PCD_COMPLAPP.c
    + Main example file.
  - intfs/NFCRDLIB_ISO10373_6_PCD_COMPLAPP.h
