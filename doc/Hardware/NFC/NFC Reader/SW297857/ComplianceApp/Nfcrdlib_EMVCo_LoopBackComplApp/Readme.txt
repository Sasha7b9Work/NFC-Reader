...
1 Document Purpose
2 Description of the Nfcrdlib_EMVCo_LoopBackComplApp
3 Restrictions on Nfcrdlib_EMVCo_LoopBackComplApp
4 Configurations of Nfcrdlib_EMVCo_LoopBackComplApp
5 Package Contents
6 Mandatory materials (not included)
7 Hardware Configuration
8 Software Configuration
9 Steps to build Nfcrdlib_EMVCo_LoopBackComplApp for LPC1769 with PN5190 using MCUXpresso
10 Steps to build Nfcrdlib_EMVCo_LoopBackComplApp for LPC1769 with PN5180 using MCUXpresso
11 Steps to build Nfcrdlib_EMVCo_LoopBackComplApp for LPC1769 with RC663 using MCUXpresso
12 Steps to build Nfcrdlib_EMVCo_LoopBackComplApp for PN7462AU using MCUXpresso
13 Steps to build Nfcrdlib_EMVCo_LoopBackComplApp for FRDM-K82F using MCUXpresso
14 Steps to build Nfcrdlib_EMVCo_LoopBackComplApp for PN76XX using Eclipse
15 Selection of Board / OSAL / Frontend (MCUXpresso)
16 Steps to follow for PI / Linux / CMake
17 Running Nfcrdlib_EMVCo_LoopBackComplApp
18 List of supported NFC Reader Boards/ICs
...
==================
  ...
  Nfcrdlib_EMVCo_LoopBackComplApp example as well as it's known problems and
  restrictions.
...
====================================================
  ...
  - Nfcrdlib_EMVCo_LoopBackComplApp can be run with CLEV663B, PN5180, PN5190,
    PN7462AU and PN76XX.  (See Section-18 for supported versions)
...
=================================================
  ...
  - Nfcrdlib_EMVCo_LoopBackComplApp is restricted to be run on NFC Reader
    Boards/ICs mentioned in Section-18.
  ...
  - This software project requires NxpNfcRdLib v07.05.00 or later.
...
===================================================
  ...
  - This example has been verified using the MP500 Test Tool.
    ...
    Note: To execute EMVCo3.0(L1) digital compliance with RC663 refer
          Section-11.  To execute EMVCo3.0(L1) digital compliance with PN76XX
          refer Section-14.
...
==================
  ...
  - Readme.txt
    + This readme file
  - Nfcrdlib_EMVCo_LoopBackComplApp.c
    + Main example file.
  - intfs/Nfcrdlib_EMVCo_LoopBackComplApp.h
...
====================================
  ...
  - LPCXpresso LPC1769 / Freedom K82 development boards For NFC ICs listed in
    Section-18 (Note: PN7462AU (Section-18 Bullet-3) does not need any other
...
========================
  ...
  - Since this example can be configured to run on various MCU ICs and various
    ...
    Section-10, Section-11, Section-12, Section-13 and Section-14.
...
=========================================================================================
  ...
  Section-19, Bullet-6 below)


10 Steps to build Nfcrdlib_EMVCo_LoopBackComplApp for LPC1769 with PN5180 using MCUXpresso
==========================================================================================

  See "Importing provided SW example projects" in AN11908 (See Section-19,
  Bullet-2 below)
...
=========================================================================================
  ...
  See "Importing provided SW example projects" in AN11022 (See Section-19,
...
===============================================================================
  ...
  - For MCUXpressio versions before MCUXpressoIDE_10.0.2, See "Adding PN7462AU
    Plugin" in UM10883. (See Section-19, Bullet-4 below)
...
================================================================================
  ...
  See "Import projects to the MCUXpresso" in AN11908. (See Section-19, Bullet-2
  below)
...
=========================================
  ...
  The steps are described in AN11802. (See Section-19, Bullet-5 below)
